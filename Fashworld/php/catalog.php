...
?>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../php/home.php">Fashworld</a>
                </div>
    ...
    <div class="container portfolio">
        ...
        <h1 class="h1-split">SHOP HERE</h1>

        <!--VIEW CART BUTTON-->
        <div class="viewCart">        
            <a href="../php/viewCart.php" class="button button-accent" title="View Cart">VIEW CART<i class="glyphicon glyphicon-shopping-cart"></i></a>
        </div>
        ...
        <figure class="port-item">   
            ...
            <img src="../img/portfolio-item-4.png" alt="portfolio item">
                        
            <?php
            //get rows query
            $query = $db->query("SELECT * FROM products WHERE id = '4' ORDER BY id DESC LIMIT 10");
             if($row = $query->fetch_assoc()){
            ?>
        ...
        <figure class="port-item">   
            ...
            <img src="../img/portfolio-item-5.png" alt="portfolio item">
                        
            <?php
            //get rows query
            $query = $db->query("SELECT * FROM products WHERE id = '5' ORDER BY id DESC LIMIT 10");
             if($row = $query->fetch_assoc()){
            ?>
        ...
        <figure class="port-item">   
            ...
            <img src="../img/portfolio-item-6.png" alt="portfolio item">
                        
            <?php
            //get rows query
            $query = $db->query("SELECT * FROM products WHERE id = '6' ORDER BY id DESC LIMIT 10");
             if($row = $query->fetch_assoc()){
            ?>
